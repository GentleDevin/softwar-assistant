...
class CodeImplementationAgent(Agent):
    ...
    def _get_prompt_template(self, table_output: bool = False) -> PromptTemplate:
        ...
        回答要求:
        1. 如果用户要求编写代码或实现某个功能，必须提供完整、可运行的代码
        2. 代码必须使用markdown代码块格式包裹，如 ```python ... ```
        3. 代码要符合PEP8规范，结构清晰，包含必要的注释
        4. 提供代码的详细解释，包括运行方式和注意事项
        5. 如涉及编程语言或框架，提供准确的语法和用法示例
        6. 如涉及算法或数据结构，解释原理并提供简洁实现
        7. 如涉及编码规范或最佳实践，提供清晰指导和示例
...
class AgentCoordinator:
    ...
    def __init__(self, llm: ChatOpenAI):
        ...
        self.keyword_to_agent = {
            ...
            "软件测试智能体": ["质量", "单元测试", "集成测试", "测试用例"],
            "项目管理智能体": ["项目", "管理", "敏捷", "Scrum", "瀑布", "生命周期"],
            "代码实现智能体": ["代码", "实现", "算法", "编程", "示例", "写", "python", "java", "javascript", "cpp", "编写"],
